...
foreach ($usuarios as $unUsuario) {
    ...
    $cliente = $rolnombre == "cliente";
    $deposito = $rolnombre == "deposito";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label><input type="radio" name="role" value="1" data-rol="1" <?php echo $cliente ? 'disabled' : ''; ?>> Cliente</label>
        <label><input type="radio" name="role" value="3" data-rol="3" <?php echo $deposito ? 'disabled' : ''; ?>> Depósito</label>
        <label><input type="radio" name="role" value="2" data-rol="2" <?php echo $admin ? 'disabled' : ''; ?>> Admin</label>
        </div>
